...
It uses the same API definitions as L<Net::Twitter>, but without the extra
bells and whistles and without the additional dependencies.  Same great taste,
less filling.
...
finer grained control over features, backwards compatibility with older
